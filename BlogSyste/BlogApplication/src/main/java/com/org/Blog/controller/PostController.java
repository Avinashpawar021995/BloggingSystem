...
import com.org.Blog.service.FileService;
...
public class PostController {
	...
	public ResponseEntity<PostResponse> getAllPost(
			...
			@RequestParam(value = "sortDiv", defaultValue = AppConstants.SORT_DIR, required = false) String sortDir)
...
// delete post 
	...
	public ApiResponse deletedPost(@PathVariable Long postId) {
		this.postService.detelePost(postId);
